...
console.log(parsorama_1.Form, typeof parsorama_1.Form);
{
    ...
    var parameter = parsorama_1.Form.new(templateObject_4 || (templateObject_4 = __makeTemplateObject(["{{{s", "s", "s}}}"], ["{{{\\s", "\\s", "\\s}}}"])), paramName, new parsorama_1.Optional(defaultExp, parsorama_1.Quantitier.LAZY));
}
